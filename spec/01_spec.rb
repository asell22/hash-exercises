...
describe 'Hash basics' do
  ...
  describe "working with person data" do
    ...
    it "repackages address data" do
      address = "#{person_data["address"]["street"]}, #{person_data["address"]["city"]}, #{person_data["address"]["state"]}, #{person_data["address"]["zip_code"]}"
...
person[:tournament_wins] = {:wimbeldon => ["1976", "1977", "1978", "1979", "1980"]}
      years_active = "Years active: #{person[tournament_wins][wimbeldon][0]}-#{person[tournament_wins][wimbeldon][3]}"
